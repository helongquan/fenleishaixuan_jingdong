...
// 检测连接
// $sql = "SELECT avg(pay) AS value , category AS name FROM job GROUP BY category";
$sql = "SELECT round(avg(pay),0) as value, category AS name FROM job GROUP BY category";
